...
class Admin(commands.Cog):
    ...
    async def reboot(self, ctx):
        ...
        embed = discord.Embed(title=f"Are you sure you want to reboot skye?", description=f"Pick ``yes`` if you want to restart, pick ``no`` if not!    ")
        ...
        try:
            ...
            await ctx.respond(
                embed=discord.Embed(title="Aborted.")
    ...
    async def dm(self, ctx, user: discord.User, *, message: str):
        ...
        try:
            ...
            await ctx.respond(f"✉️ Sent a DM to **{user}**" )
        except discord.Forbidden:
            await ctx.respond("This user might be having DMs blocked or it's a bot account...")
